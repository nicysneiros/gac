...
class ProdutoForm (ModelForm):
	...
	class Meta:
		model = Produto
		fields = ['descricao', 'categoria','tamanho','valor','titulo']
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['categoria'].widget.attrs.update({'class':'span3','rows':'1'})
		self.fields['tamanho'].widget.attrs.update({'class':'span1','rows':'1'})
		...
		self.fields ['titulo'].widget.attrs.update({'class':'span3','rows':'1'})
